...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	ОбновлениеИнформационнойБазыПарковка.ПриОпределенииНастроек(Параметры);
	// _Демо конец примера
...
Процедура ПриФормированииСпискаРазрабатываемыхПодсистем(РазрабатываемыеПодсистемы) Экспорт
	...
	// _Демо начало примера
	ОбновлениеИнформационнойБазыПарковка.ПриФормированииСпискаРазрабатываемыхПодсистем(РазрабатываемыеПодсистемы);
	// _Демо конец примера
