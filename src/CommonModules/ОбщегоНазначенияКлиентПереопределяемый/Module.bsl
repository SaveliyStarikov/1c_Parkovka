...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	//КонецЕсли;
	//
	//Если СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиентаПриЗапуске().ПредлагатьПерейтиНаСайтПриЗапуске Тогда
	...
	//_ДемоОбменМобильныйКлиентКлиент.ПриНачалеРаботыСистемы(); 
	// _Демо конец примера
...
Процедура ПриОбработкеПараметровЗапуска(ПараметрыЗапуска, Отказ) Экспорт
	...
	Если ПараметрыЗапуска.Найти("ИндивидуальноеРабочееМесто") <> Неопределено
		ИЛИ ПараметрыЗапуска.Найти("РабочееМесто") <> Неопределено 
		ИЛИ ПараметрыЗапуска.Найти("РМ") <> Неопределено Тогда
			//ОбновитьИнтерфейс();
			//ОткрытьФорму("Обработка.МониторингПарковки.Форма.Форма");
	КонецЕсли;
