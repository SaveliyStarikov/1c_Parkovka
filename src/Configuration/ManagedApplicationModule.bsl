...
#КонецЕсли
	...
	Если    СтрНайти(ПараметрЗапуска, "ИндивидуальноеРабочееМесто")
		ИЛИ СтрНайти(ПараметрЗапуска, "РабочееМесто")
		ИЛИ СтрНайти(ПараметрЗапуска, "РМ") 
		Или СтрНайти(ПараметрЗапуска, "ИнформационноеТабло")
	Тогда
